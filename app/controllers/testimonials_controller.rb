class TestimonialsController < ApplicationController
  def show
    ...
    @quotes = [@testimonialspage.aaron_quote, @testimonialspage.chris_quote, @testimonialspage.tyler_text, @testimonialspage.client1_text, @testimonialspage.client2_text, @testimonialspage.client3_text]
  end
end
